...
- Task 4 已确认采用通用 JSON object payload，并固定新工单初始状态为 `created`；聚焦实施计划位于 `docs/superpowers/plans/2026-07-16-work-order-idempotency.md`，已完成自审，尚未写生产代码或 Task 4 测试。
...
2. 只实施 OperCerta；按 `docs/superpowers/plans/2026-07-16-work-order-idempotency.md` 使用 inline execution，从领域非法输入 RED 开始幂等写入 TDD。
