"""Run the frozen replenishment suite through the real integration boundaries."""
...
def main() -> None:
    ...
    parser.add_argument("--suite", type=Path, default=Path("data/evals/replenishment-v3.json"))
